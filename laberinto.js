export const mazegen = (function() {
    // Función interna que selecciona un elemento de forma aleatoria basándose en una ruleta.
    ...
    // Función interna para generar una clave única a partir de coordenadas (x, y).
    function _Key(x, y) {
      return x + '.' + y;
    }
  
    // Exporta un objeto con una clase llamada MazeGenerator.
    return {
      MazeGenerator: class {
        constructor(nodes) {
          this._nodes = nodes;
